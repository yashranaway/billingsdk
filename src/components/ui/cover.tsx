...
export const Cover = ({
  ...
  return (
    <div
      ...
      ref={ref}
      className="group/cover relative inline-block rounded-sm bg-neutral-100 px-2 pb-2 leading-none transition duration-200 hover:bg-neutral-900 dark:bg-neutral-900"
    >
      <AnimatePresence>
        {hovered && (
          <motion.div
