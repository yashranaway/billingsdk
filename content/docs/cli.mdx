...
2. Installs the component files in your `components/@billingsdk/cli/` directory
...
<Callout title="Need Help?">
  If you encounter issues or have questions about the CLI, please [open an issue](https://github.com/dodopayments/@billingsdk/cli/issues) on GitHub.
</Callout>
