...
---
    ...
    <include cwd lang="tsx" meta='title="src/components/billing-settings-component.tsx"'>src/components/billing-setting-demo.tsx</include>
    </Tab>
    </Tabs>
...
<Tabs items={['npx', 'pnpm', 'yarn']} defaultValue="npx" groupId="installation-tabs">
 title: Billing Settings description: The Billing Settings component provides a user-friendly interface for managing billing preferences, payment methods, invoices, and usage limits. This component features a tabbed navigation system, form controls, and an interactive payment card management section.
...
<Tab value="Code" className="mt-3">
<include cwd lang="tsx" meta='title="src/components/billing-settings-component.tsx"'>src/components/billing-settings-component.tsx</include>
</Tab>
</Tabs>
</Tabs>
...
<Tabs items={['npx', 'pnpm', 'yarn']} defaultValue="npx" groupId="installation-tabs">
    ...
    ```bash 
      npx shadcn@latest add https://billingsdk.com/r/billing-setting.json 
      ```
    </Tab>
    <Tab value="pnpm">
    
   ``` bash 
      pnpm dlx shadcn@latest add https://billingsdk.com/r/billing-settings.json ```
    </Tab>
    <Tab value="yarn">
    
    ```bash 
      yarn dlx shadcn@latest add https://billingsdk.com/r/billing-settings.json
      ``` 
    </Tab>
</Tabs>
