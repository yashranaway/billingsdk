...
<Tabs items={['Preview', 'Code']} className="bg-transparent border-none">
  ...
  <include cwd lang="tsx" meta='title="src/components/billingsdk/cancel-subscription-dialog.tsx"'>src/components/billingsdk/cancel-subscription-dialog.tsx</include>
