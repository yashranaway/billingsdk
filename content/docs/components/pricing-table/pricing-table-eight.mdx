...
description: The Pricing Table Eight component provides a feature-comparison pricing table with aligned cards and user slider for comprehensive plan comparison.
---
...
<Tabs items={['Preview', 'Code']} className="bg-transparent border-none">
  <Tab value="Preview" className="border-none bg-transparent p-0 mt-3">
    <PreviewComponents registryName="pricing-table-eight">
...
|------|------|-------------|
| `plans` | `PricingTableEightPlan[]` | Array of pricing plans |
...
### PricingTableEightPlan

```tsx
interface PricingTableEightPlan {
...
- **User Slider**: Visual indicator showing current plan's user count
...
### Credits
- Created by [@rajoninternet](https://x.com/rajoninternet) & [@Aditya Garud](https://aditya-garud.me/)
