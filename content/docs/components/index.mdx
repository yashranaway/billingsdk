...
| **[Payment Method Manager UPI](/docs/components/payment-method-manager/upi)** | Complete UI for managing UPI payment methods with add, edit, remove, and set default operations |
