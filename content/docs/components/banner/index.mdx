...
<Tabs items={['Preview', 'Usage Code', 'Code']} className="bg-transparent border-none">
...
<Tab value="Usage Code" className="mt-3">
  ...
  <include cwd lang="tsx" meta='title="src/components/billingsdk/banner.tsx"'>src/components/billingsdk/banner.tsx</include>
  </Tab>
</Tabs>
