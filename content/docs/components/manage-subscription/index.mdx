...
- **Current Plan Display**: Shows plan title, pricing, and status
- **Billing Information**: Displays next billing date and payment method
- **Plan Features**: Lists all features included in the current plan
- **Action Buttons**: Integrated update plan and cancel subscription dialogs
- **Responsive Design**: Adapts to different screen sizes
- **Status Indicators**: Visual badges for plan status and billing cycle
